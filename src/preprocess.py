...
def create_preprocessing_pipeline(df):
    ...
    categorical_features = ['exclusive-new', 'brand', 'customer_review', 'material_type', 'product_category']
...
def run_preprocessing():
    ...
    # (Note: In a real project, you might save X_train/y_train separately)
